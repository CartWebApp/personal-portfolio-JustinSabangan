(function () {
  const projectPicker = document.getElementById("writing-picker");

  const detailByKey = {
    research: document.getElementById("detail-research"),
    argumentative: document.getElementById("detail-argumentative")
  };
  ...
  function openProject(projectKey) {
    ...
    document.body.classList.add("writing-detail-open");
    projectPicker.hidden = true;
    projectPicker.setAttribute("aria-hidden", "true");

    detailPanel.hidden = false;

    const scrollArea = detailPanel.querySelector(".writing-detail-scroll");
    if (scrollArea) {
  ...
  function backToPicker() {
    document.body.classList.remove("writing-detail-open");
    if (projectPicker) {
  ...
  const backButtons = document.querySelectorAll(".writing-back");
